...
- [Fable-as-advisor verifier](decision-advisor-verifier.md): Design-only, deferred; SDK-only, opt-in; advisor over full Fable; respects #66714; addition not replacement for cross-family.
