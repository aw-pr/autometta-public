...
cat >"$fake_refs" <<'REFS'
export OP_REF_GROQ_API_KEY="op://fixture-vault/fake-groq-item/credential"
export OP_REF_OPENROUTER_API_KEY="op://fixture-vault/fake-openrouter-item/credential"
REFS
