...
- A real adopter worker log to confirm output format, e.g. `/Users/YOURNAME/repos/emergence-lab/state/logs/02-fractal-defaults-and-cycling-worker.log` (read-only)
